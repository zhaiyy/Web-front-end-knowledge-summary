...
2. [什么是行内元素，块级元素及区别](#什么是行内元素，块级元素及区别)
...
6. [实现布局左侧固定尺寸,右侧自适应](#实现布局左侧固定尺寸,右侧自适应)
----------------------------------
...
5. [什么是事件委托](#什么是事件委托)
6. [实现事件模型](#实现事件模型)
7. [事件如何派发也就是事件广播（dispatchEvent）](#事件如何派发也就是事件广播（dispatchEvent）)
8. [JavaScript 作用域和作用域链](#JavaScript作用域和作用域链)
9. [谈谈对闭包的理解。闭包会造成哪些影响？为什么会造成该影响？](#谈谈对闭包的理解。闭包会造成哪些影响？为什么会造成该影响？)
10. [函数节流](#函数节流)
11. [设计模式](#设计模式)
...
24. [sessionStorage，cookie，localStorage](#sessionStorage，cookie，localStorage)
----------------------------------
### 什么是事件冒泡
